...
export class ShipmentService {
  ...
  updateShipment(id: number, request: { shipmentNumber?: string; carrier?: string; trackingNumber?: string; shippingCost?: number; weight?: number; notes?: string; shippingAddressId?: number; length?: number; width?: number; height?: number }): Observable<void> {
