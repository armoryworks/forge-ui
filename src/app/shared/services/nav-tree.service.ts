      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            { icon: 'fact_check', label: 'Compliance', i18nKey: 'admin.tabs.compliance', route: '/admin/compliance', capability: 'CAP-QC-COMPLIANCE-FORMS', allowedRoles: ['Admin', 'Manager', 'OfficeManager'] },
